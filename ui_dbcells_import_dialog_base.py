...
class Ui_DBCellsImportDialogBase(object):
    def setupUi(self, DBCellsImportDialogBase):
        ...
        self.lineDataset = QtWidgets.QLineEdit(DBCellsImportDialogBase)
    ...
    def retranslateUi(self, DBCellsImportDialogBase):
        ...
        self.label_2.setText(_translate("DBCellsImportDialogBase", "Dataset ID"))
        self.lineDataset.setText(_translate("DBCellsImportDialogBase", "landchangedata/novoprojeto"))
